...
graph TD
    subgraph GATES["Quality Gates theo Stage"]
        ...
        G25["Stage 2.5: Drift+Gate<br/>DRIFT-1.0 Back-link check<br/>DRIFT-2.0 Contract alignment<br/>DRIFT-3.0 State alignment<br/>DRIFT-4.0 Zone alignment<br/>---<br/>SAUDIT-1.0 Sampling audit enabled<br/>SAUDIT-1.1 Adaptive rate tracking<br/>(last_5_results in _state.yaml)<br/>SAUDIT-1.2 audit-fail-report.md<br/>generated on FAIL"]
